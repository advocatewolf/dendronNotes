---
id: ei41ghsoi8p4j9z5t6ywyu7
title: Reserved Words
desc: ''
updated: 1661417329204
created: 1661405536807
---
[ref.](https://www.alibabacloud.com/help/en/maxcompute/latest/reserved-words-and-keywords)

## Notice:
- cannot be used to name a table, column, or partition, otherwise an error occurs.
- not case sensitive.
``` %    &    &&    (    )    *    +
-    .    /    ;    <    <=    <>
=    >    >=    ?    ADD    AFTER    ALL
